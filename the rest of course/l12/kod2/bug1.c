  ...
  for (i=0; i < TCOUNT; i++) {
    ...
    */
    if (count == COUNT_LIMIT) {
      ...
      // Wyslij do wszystkich ze jest osiagnieto
...
int main(int argc, char *argv[])
{
  ...
  // ustaw atrybut zmiennej warunkowej
  pthread_condattr_t AtrybutWar;
  ...
  */
  ...
  // Ustawia AtrybutWar jako dostepny pomiedzy procesy
  pthread_condattr_setpshared(&AtrybutWar, PTHREAD_PROCESS_SHARED);
